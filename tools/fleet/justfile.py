...
#
# Mac nix-darwin recipes (darwin-build / darwin-debug) are private-only and are
# NOT in this template — add them in your private Justfile if needed. Running
# `just up` rewrites this file from the template and will drop private-only recipes.
...
# Warning: drops private-only recipes (e.g. darwin-build) — re-add after.
up:
